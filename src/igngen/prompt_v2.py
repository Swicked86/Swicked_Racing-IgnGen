...
from .v2_engine import EngineParameters, describe_spec, find_engine_profile, list_engine_profiles, load_engine_profile
...
def prompt_engine_choice_v2() -> EngineParameters:
...
def prompt_review_engine_v2(spec: EngineParameters) -> EngineParameters:
    """Review every calibration input used by the V2 generator.

    Enter accepts the engine-profile value. This deliberately includes the new
    idle pocket geometry/MAP band, vacuum endpoint, boost absolute timing limit,
    boost gain, and limiter/overspeed values.
    """
...
def prompt_preset_v2(default: str="base") -> str:
...
def prompt_layout_v2(default: str="default") -> str:
...
def prompt_export_v2(default: str="default") -> str:
...
def prompt_output_path_v2(default: str="map.csv") -> str:
